...
################################################################################
SC <- read.csv("2007Jan_SC_raw.csv", skip = 4) ##manually filled trap station names, can do this in R for other datasheets
...
#save blank values of SC_clean as NA in the type.of.hits column (need NA values for fill function to work, it seems)
