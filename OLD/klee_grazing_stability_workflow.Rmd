...
## reorder treatments to match grazing pressure.
meanvar6$TREATMENT <- as.factor(meanvar6$TREATMENT) #change treatment to factor
meanvar6$TREATMENT <- factor(meanvar6$TREATMENT, levels = c("0", "W",  "MW",  "C", "MWC", "WC"))
...
#  replicate.var = "Unique_ID"
#)
#colnames(annloreausyn) <- c("Unique_ID", "loreau_synchrony")

#ann <- ggplot(annloreausyn, aes(x=Unique_ID, y=loreau_synchrony)) +
 # geom_point()

#biann <- ggplot(loreau_synchrony, aes(x=Unique_ID, y=loreau_synchrony)) +
 # geom_point()
